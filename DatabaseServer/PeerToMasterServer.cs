...
namespace DatabaseServer
{
    ...
    /// 作者：taixihuase
    /// 作用：用于数据库服务器与主服务器之间的数据传输
    /// 编写日期：2016/1/25
    /// </summary>
    public class PeerToMasterServer : OutboundS2SPeer
    {
        public readonly DatabaseServerApplication Server;
        ...
        public PeerToMasterServer(DatabaseServerApplication server) : base(server)
        {
            Server = server;
            Initialize();
        }
        ...
        /// 作者：taixihuase
        /// 作用：数据库服务器发送请求后，接收并处理相应的主服务器响应内容
        /// 编写日期：2016/1/25
        /// </summary>
