...
namespace LoginServer
{
    ...
    /// 作者：taixihuase
    /// 作用：用于登录服务器与主服务器之间的数据传输
    /// 编写日期：2016/1/25
    /// </summary>
    public class PeerToMasterServer : OutboundS2SPeer
    {
        public readonly LoginServerApplication Server;
        ...
        public PeerToMasterServer(LoginServerApplication server) : base(server)
        {
            Server = server;
            Initialize();
        }
        ...
        /// 作者：taixihuase
        /// 作用：登录服务器发送请求后，接收并处理相应的主服务器响应内容
        /// 编写日期：2016/1/25
        /// </summary>
        ...
        protected override void OnOperationResponse(OperationResponse operationResponse, SendParameters sendParameters)
        {
            switch ((S2SOpCode) operationResponse.OperationCode)
            {
                ...
                case S2SOpCode.ReportServerLoad:
                    ...
                    #region Login and Regist Op

                case S2SOpCode.ClientApplyForCaptcha:
                    Regist.OnResponse(operationResponse, sendParameters);
                    break;
